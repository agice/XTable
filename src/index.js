...
const xTable = ReactDOM.render(<XTable ref={(x) => {window.ourComponent = x}} model = {model} />, document.getElementById('root'));
  ...
  document.getElementById('dlKey').addEventListener("change", function() {
    window.ourComponent.changeKey(parseInt(this.value));
  })
